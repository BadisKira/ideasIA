...
const TextArea: React.FC<TextAreaInterface> = ({ value, handleChange ,setValue}) => {
    const empty=""
    const eraseValue = () => {
        setValue (empty)
    }
        ...
        <>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                <div className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                    <div className="flex flex-wrap items-center divide-gray-200 sm:divide-x dark:divide-gray-600">
                        <div className="flex items-center space-x-1 sm:pr-4">
                            ...
                            <button onClick={copyValue} type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                    ...
                    {/* <button type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                     ...
                     <button onClick={eraseValue} type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                        <svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            height="1em"
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea id="editor" value={value} onChange={handleChange} rows={8} className="block w-full px-0 text-sm text-gray-800 bg-white  border-0 dark:bg-gray-800 focus:ring-0 focus:border-0 outline-none dark:text-white dark:placeholder-gray-400"  required></textarea>
                </div>
            </div>
